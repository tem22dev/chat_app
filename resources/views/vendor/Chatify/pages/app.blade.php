...
<div class="messenger">
    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-header">
            <nav>
                <a href="#" class="logo">
                    ...
                    <span class="messenger-headTitle">Call Space</span>
                </a>
                {{-- header buttons --}}
        ...
        <div class="m-body contacts-container">
            ...
            <div class="show messenger-tab users-tab app-scroll" data-view="users">
                ...
                {{-- Contact --}}
                <p class="messenger-title"><span>Tất cả các tin nhắn</span></p>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Vui lòng chọn người bạn để bắt đầu nhắn tin</span></p>
            </div>
            {{-- Typing indicator --}}
