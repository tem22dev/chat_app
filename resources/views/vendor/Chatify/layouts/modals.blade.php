...
<div class="app-modal" data-name="delete">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="delete" data-modal='0'>
            <div class="app-modal-header">Bạn chắc chắn muốn xoá cái này không?</div>
            <div class="app-modal-body">Bạn không thể hoàn tác hành động này</div>
            <div class="app-modal-footer">
                <a href="javascript:void(0)" class="app-btn cancel">Trở lại</a>
                <a href="javascript:void(0)" class="app-btn a-btn-danger delete">Xoá</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="app-modal-card" data-name="settings" data-modal='0'>
            <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data"
                ...
                <div class="app-modal-body">
                    ...
                    {{-- Dark/Light Mode  --}}
                    <p class="divider"></p>
                    <p class="app-modal-header">Chế độ tối <span
                            class="
